...
* Generated by: s2180506;
* Date: 07JAN2024:11:31:29;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
description= "Decision Tree 4 Leaves";
diagramID="_ROOT_";
parentID="";
X=968;
Y=372;
...
id= "Tree4";
component="DecisionTree";
description= "Decision Tree (Maximal)";
diagramID="_ROOT_";
parentID="";
X=967;
Y=24;
...
id= "Tree3";
component="DecisionTree";
description= "Decision Tree (Average Squared Error)";
diagramID="_ROOT_";
parentID="";
X=969;
Y=208;
...
id= "Tree2";
component="DecisionTree";
description= "Decision Tree 3 Leaves";
diagramID="_ROOT_";
parentID="";
X=968;
Y=285;
...
run;
*------------------------------------------------------------*;
* CROSSTAB Data Set for Stat2;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* EMNOTES File for Stat2;
*------------------------------------------------------------*;
data _null_;
if symget('sysscp')=:'WIN' then dsep='\';
else if symget('sysscp')=:'DNT' then dsep='\';
else dsep = '/';
filepath = pathname('work')!!dsep!!"Stat2_EMNOTES.txt";
call symput('DSPATH', filepath);
run;
data _null_;
filename dspath "&dspath" encoding="utf-8" NOBOM;
...
id= "FIMPORT";
property="IFileName";
value= "C:\Users\user\Downloads\data2.csv";
output;
id= "FIMPORT";
